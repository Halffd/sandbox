...
Registro le_registro(int conta) { return registro; }

void grava_registro(Registro reg, int conta) { registro = reg; }
...
int main() {
  ...
  pid1 =
      clone(funcaoDeposito, pilha1 + TAMANHO_PILHA, CLONE_VM | SIGCHLD, NULL);
